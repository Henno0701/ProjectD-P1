      ...
      <View className="flex-1 bg-main_bg_color">
        ...
        <View>
          ...
          <View className="mr-5 ml-5 w-auto h-20 flex flex-row">
            <View className="h-auto mr-5 flex-1 bg-secondary_bg_color rounded-xl justify-center">
              <Text className="ml-5 mb-1 text-[#ffffff] text-base">Battery</Text>
              <Text className="ml-5 text-[#686868]">Power: {Battery}%</Text>
            </View>

            {/* Here needs to be an if statement that shows info of reservation if there is one */}
            {/* !needs function that checks time left */}
            <View className=" h-20 flex-1 bg-secondary_bg_color justify-center rounded-xl">
              <Text className="text-[#ffffff] ml-5 text-base">Time left</Text>
            </View>
          </View>

          {/* Here needs to be an if statement that shows info of reservation if there is one */}
          {/* !needs function that checks information about the charging station */}
          <View className="bg-secondary_bg_color w-auto h-auto ml-5 mr-5 justify-center mt-3 rounded-xl">
            <Text className="ml-5 mb-3 mt-5 text-[#7C7C7C]">Info</Text>

            <View className="flex flex-row">
              <Text className="ml-5 text-[#686868]">Charging Station:</Text>
              <Text className="ml-5 text-[#ffffff]">{Station}</Text>
            </View>

            <View className="flex flex-row">
              <Text className="ml-5 text-[#686868]">Charging KW:</Text>
              <Text className="ml-5 text-[#ffffff]">{Charge} kW</Text>
            </View>

            <View className="flex flex-row">
              <Text className="ml-5 text-[#686868]">License Plate:</Text>
              <Text className="ml-5 mb-5 text-[#ffffff]">{License}</Text>
            </View>
          </View>
        </View>
        :null}
